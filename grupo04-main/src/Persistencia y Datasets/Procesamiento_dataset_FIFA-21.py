...
def abrir_archivo_y_obtener_datos():
    """Procesa y retorna csv del archivo FIFA
    """
    dir_entrada = os.path.join(dir, "Datasets", "FIFA-21 Complete.csv")
...
def dir_salida():
    route_new_csv = os.path.join(dir, "Datasets", "FIFA-21 Complete Modificado.csv")
    return route_new_csv
